...
import DigitalDogFeature from "../components/DigitalDogFeature";
...
function DogKozmo() {
  return (
    <svg
      role="img"
      aria-label="Kozmo the space dog"
      width="160"
      height="200"
      viewBox="0 0 160 200"
      fill="none"
        ...
        >
          <button
            ...
            style={{
              ...
              boxShadow:
                "0 0 32px rgba(168,107,255,0.45), 0 0 64px rgba(255,90,214,0.15)",
            ...
            onMouseEnter={(e) => {
              ...
              (e.currentTarget as HTMLButtonElement).style.boxShadow =
                "0 0 50px rgba(168,107,255,0.65), 0 0 90px rgba(255,90,214,0.25)";
            }}
            onMouseLeave={(e) => {
              (e.currentTarget as HTMLButtonElement).style.transform = "";
              (e.currentTarget as HTMLButtonElement).style.boxShadow =
      ...
      <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
        ...
        >
          {HOW_STEPS.map((step) => (
            <div
              key={step.num}
              className="card-hover observe-reveal"
              style={{
        ...
        <div style={{ textAlign: "center", marginTop: "48px" }}>
          <a
            ...
            onMouseLeave={(e) => {
              ...
              (e.currentTarget as HTMLAnchorElement).style.color = "#A86BFF";
            }}
          >
            Start Creating →
          </a>
  ...
  return (
    ...
    >
      <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
        ...
        {/* MY_DOGS_URL is empty until gallery exists — button hidden intentionally */}
      </div>
    </section>
  );
}
